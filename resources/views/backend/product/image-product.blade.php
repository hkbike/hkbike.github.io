		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					...
					<i class="fa fa-angle-right"></i><a><i>Thêm ảnh Sản phẩm</i></a>
...
<div class="row">
		...
		<div class="col-md-8 thong-tin-sp">
			<div class="panel panel-primary">
            <div class="panel-heading">
                <i class="fa fa-image"></i> Tất cả ảnh sản phẩm
            </div>
						...
						<table class="table table-hover table-striped ">
							...
							<tbody>
								...
								<tr class="show_1">
									...
									<td>Stock</td>
									@endif
									<td><a href="edit-img/{{$pdimg->id}}" class="btn btn-success"><i class="fa fa-edit">  Sửa</i></a></td>
									<!-- <a href="delete-img/{{$pdimg->id}}" onclick="return confirm('bạn có chắc chắn muốn xóa?..')" class="btn btn-danger"><i class="fa fa-trash">  Xóa</i></a> -->
